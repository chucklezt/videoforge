#!/usr/bin/env python3
"""Experiment 4: Extended inference with detailed scene prompt."""
...
OUTPUT_PATH = os.path.expanduser(
    "~/videoforge/output/inference/experiment4_seinfeld_diner.mp4"
)
...
# 49 frames OOMs at 480x480; stick with 33 but push steps to 60
NUM_FRAMES = 33
WIDTH = 480
HEIGHT = 480
FPS = 16
...
def main():
    ...
    print(f"\n{'='*60}")
    print("Experiment 4 — 480x480, 49 frames, 60 steps, cfg 6.5")
    print(f"{'='*60}")
